...
const PHOTOS = {
  ...
  editorial3: "https://images.unsplash.com/photo-1616587226960-4a03badbe8bf?auto=format&fit=crop&w=800&q=80",
  howItWorks1: "https://images.unsplash.com/photo-1611532736597-de2d4265fba3?auto=format&fit=crop&w=800&q=80",
  howItWorks2: "https://images.unsplash.com/photo-1587825140708-dfaf18c4f42c?auto=format&fit=crop&w=800&q=80",
...
const features = [
  ...
  },
  {
    ...
    description: "Precise start/end timestamps for every sentence in the audio.",
  },
  {
    icon: Shield,
    title: "Encrypted & Private",
    description: "Your files are encrypted end-to-end and stored securely. Delete anytime.",
  },
];

const testimonials = [
  {
    quote: "TypeMyAudio cut my podcast editing time in half. The transcriptions are incredibly accurate, even with multiple speakers.",
    name: "Marcus Chen",
    role: "Podcast Producer",
    photo: PHOTOS.testimonial1,
  },
  {
    quote: "As a journalist working across borders, the auto-translation feature is a game-changer. I transcribe interviews in any language.",
    name: "Sofia Bergmann",
    role: "Foreign Correspondent",
    photo: PHOTOS.testimonial2,
  },
  {
    quote: "We use it for every board meeting. Upload the recording, get a clean transcript with timecodes — it's that simple.",
    name: "David Okafor",
...
const steps = [
  {
    ...
    description: "Drag and drop any MP3 or MP4 file up to 500MB. That's it — no configuration needed.",
    photo: PHOTOS.howItWorks1,
    icon: Upload,
  },
  {
    number: "02",
    title: "Transcribe",
    subtitle: "AI does the work",
    description: "OpenAI Whisper auto-detects the language and transcribes with best-in-class accuracy. GPT-4o cleans up grammar and generates summaries.",
    photo: PHOTOS.howItWorks2,
    icon: Sparkles,
  },
  {
    number: "03",
    ...
    description: "Download as PDF, DOCX, TXT, or SRT subtitles. Edit inline, translate to 40+ languages, share with your team.",
    photo: PHOTOS.howItWorks3,
    icon: FileText,
  },
];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-3xl animate-fade-in-up">
            <h1 className="editorial-display text-[#FACC15] text-5xl sm:text-6xl md:text-7xl lg:text-8xl mb-6">
              Every word,{" "}
              <span className="editorial-italic text-primary-light">captured</span>
            </h1>
            <p className="text-lg md:text-xl text-white/70 max-w-xl mb-10 leading-relaxed">
              Upload your audio or video. Get a precise, AI-powered transcription
              in seconds — in 98+ languages, with translation, export, and editing built in.
            </p>
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <Link to="/pricing">
                <Button
                  variant="ghost"
                  size="lg"
                  className="text-white hover:bg-white/10 text-base px-8"
                >
                  View Pricing
                </Button>
              </Link>
            ...
            <p className="text-sm text-white/40 mt-6">
              3 free transcriptions — no credit card required
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <h2 className="editorial-display text-4xl md:text-5xl mb-6">
              Transcription,{" "}
              <span className="editorial-italic">reimagined</span>
            </h2>
            <div className="magazine-divider mb-8" />
            <p className="body-lg mb-6 leading-relaxed">
              TypeMyAudio is built for professionals who value accuracy and speed.
              Whether you're a journalist on deadline, a podcaster editing episodes,
              or a team documenting meetings — we turn spoken words into clean,
              exportable text.
            </p>
            <p className="body-base mb-8 leading-relaxed">
              Powered by OpenAI Whisper for transcription and GPT-4o for intelligent
              cleanup, our platform auto-detects language, corrects grammar, and
              generates summaries — all without human intervention.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 mb-20">
            <div className="lg:col-span-1">
              ...
              <h2 className="editorial-display text-white text-4xl md:text-5xl mb-6">
                Built for{" "}
                <span className="editorial-italic text-primary-light">precision</span>
              </h2>
              <div className="magazine-divider mb-6" />
              <p className="text-white/60 leading-relaxed">
                Every feature is designed around a single principle: get you from
                audio to polished text as fast and accurately as possible.
              </p>
            </div>
      ...
      <section id="how-it-works" className="max-w-7xl mx-auto px-6 py-24 md:py-32">
        <div className="text-center mb-20">
          ...
          <h2 className="editorial-display text-4xl md:text-5xl mb-4">
            Three steps to{" "}
            <span className="editorial-italic">clarity</span>
          </h2>
        </div>
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className={`relative ${i % 2 === 1 ? "lg:order-2" : ""}`}>
                ...
                <div className="absolute -top-6 -left-4 section-number select-none">
                  {step.number}
                </div>
              </div>
      ...
      <section id="testimonials" className="bg-surface">
        <div className="max-w-7xl mx-auto px-6 py-24 md:py-32">
          <div className="text-center mb-20">
            ...
            <h2 className="editorial-display text-4xl md:text-5xl mb-4">
              Voices of{" "}
              <span className="editorial-italic">confidence</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <div
                key={t.name}
                className="bg-white rounded-2xl p-8 shadow-xs hover:shadow-lg transition-shadow duration-300 flex flex-col"
              >
      ...
      <section className="relative min-h-[36rem] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 w-full">
          <div className="max-w-lg">
            ...
            <h2 className="editorial-display text-white text-4xl md:text-5xl mb-6">
              Ready to turn sound into{" "}
              <span className="editorial-italic text-primary-light">text</span>?
            </h2>
            <div className="magazine-divider mb-6 opacity-60" />
            <p className="text-white/60 mb-10 leading-relaxed">
              Join thousands of professionals who trust TypeMyAudio for accurate,
              fast transcriptions. Start free — no credit card required.
            </p>
            <Link to="/register">
              <Button size="lg" className="text-base px-8 gap-3">
                Start Transcribing Free
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <img
                ...
                alt="TypeMyAudio"
                className="h-14 w-auto mb-4 brightness-0 invert opacity-80"
              />
              <p className="text-sm leading-relaxed max-w-sm">
                AI-powered transcription for audio and video files. Auto-detect language,
                translate, and export to PDF, DOCX, TXT, or SRT — all in one platform.
              </p>
            </div>
            <div>
              <h4 className="text-white font-semibold text-sm mb-4" style={{ fontFamily: "var(--font-heading)" }}>
                Product
              </h4>
