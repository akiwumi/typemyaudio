      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <h3 className="heading-sm text-lg mb-1">
                ...
                <CardContent className="flex items-center justify-between py-4">
                  ...
                  <div className="flex items-center gap-3 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg hover:bg-red-50 text-foreground-muted hover:text-red-500 transition-colors cursor-pointer"
                    >
